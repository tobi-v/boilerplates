...
alias inst="pre && rm -rf build/ dist/ *.egg-info/ && USE_PREBUILT=ON python -m build --wheel && pip install dist/tobi-1.0.0-cp312-cp312-linux_x86_64.whl --force-reinstall"
